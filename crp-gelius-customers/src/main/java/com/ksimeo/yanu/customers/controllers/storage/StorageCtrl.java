...
/**
 * @author Ksimeo. Created on 30.08.2016 at 19:48 for "crp-gelius" project.
 * @version 1.0
 * @since 1.0
 */
@WebServlet(urlPatterns = "/storage.do")
public class StorageCtrl extends HttpServlet {
    @Autowired
    private PlansService planServ;

    private static final Logger log = Logger.getLogger(StorageCtrl.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Plan> plans = planServ.getPlansForStorage();
