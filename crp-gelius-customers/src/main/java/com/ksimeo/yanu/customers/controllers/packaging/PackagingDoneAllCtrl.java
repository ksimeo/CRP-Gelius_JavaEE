...
/**
 * @author Ksimeo. Created on 01.09.2016 at 21:06 for "crp-gelius" project.
 * @version 1.0
 * @since 1.0
 */
@WebServlet(urlPatterns = "/allpackagingdone.do")
public class PackagingDoneAllCtrl extends HttpServlet {
    @Autowired
    private PlansService planServ;

    private static final Logger log = Logger.getLogger(PackagingDoneAllCtrl.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id != null && !(id.equals(""))) {
            ...
            planServ.getPlan(planId).setPackagingDateFact(new Date());
